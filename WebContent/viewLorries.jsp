...
<div class="row">
		<div class="col-md-8">
			<h4 style="color:green" ><font><strong>Lorries details</strong></font></h4>
		</div>
	...
	<div>
			...
			<%
				try{
					...
					if(search != null){
						query = "select * from lorries where number_plate like '%"+search+"%' or insurance_company like '%"+search+"%' or premium like '%"+search+"%' or vehicle_condition like '%"+search+"%' or purchase_date like '%"+search+"%' or assigned_driver like '%"+search+"%'";
					} else {
						query = "select * from lorries";
					}
					//create a statement
				...
				<div class="modal modal-danger " id="delete_modal<%= rs.getInt("id")%>" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
							<form action="DeleteLorry" method="POST">
								<input type="hidden" name="id" value='<%=rs.getInt("id") %>'/>
								<div class="form-group">
